...
/**
 * SVGD to SVG code generation.
 */
public class AcceleoGenerateSVGDtoSVGAction extends ActionDelegate implements IActionDelegate {
				...
				public void run(IProgressMonitor monitor) {
					try {
						...
						while (filesIt.hasNext()) {
							...
							try {
								IContainer target = model.getProject().getFolder("target/generated-sources");
